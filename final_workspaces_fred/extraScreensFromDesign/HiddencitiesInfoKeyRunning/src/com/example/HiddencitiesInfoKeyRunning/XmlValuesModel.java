...
public class XmlValuesModel {
     ...
     public void setGpsAudioPlayerId(int gpsAduioPlayerId){
          this.gpsAduioPlayerId=gpsAduioPlayerId;
     }
     
     public void setGpsAudioPlayerLat(float gpsAudioPlayerLat){
          this.gpsAudioPlayerLat=gpsAudioPlayerLat;
     }
     
     public void setGpsAudioPlayerLong(float gpsAudioPlayerLong){
          this.gpsAudioPlayerLong=gpsAudioPlayerLong;
     }
     ...
     public int getGpsAudioPlayerId(){
          return this.gpsAduioPlayerId;
     }
     
     public float getGpsAudioPlayerLat(){
          return this.gpsAudioPlayerLat;
     }
     
     public float getGpsAudioPlayerLong(){
          return this.gpsAudioPlayerLong;
     }
