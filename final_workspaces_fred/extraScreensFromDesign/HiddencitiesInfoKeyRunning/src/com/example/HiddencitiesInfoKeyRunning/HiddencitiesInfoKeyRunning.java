package com.example.HiddencitiesInfoKeyRunning;
import com.example.HiddencitiesInfoKeyRunning.XMLParser;
import com.example.HiddencitiesInfoKeyRunning.XmlValuesModel;
import com.example.hiddencitiesinfokey.R;
...
public class HiddencitiesInfoKeyRunning extends Activity implements OnTouchListener {

	private Button exitInfoKeyRunningBtn;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hc_info_key_running);
		...
		exitInfoKeyRunningBtn = (Button) findViewById(R.id.exitInfoKeyRunningBtn);
		exitInfoKeyRunningBtn.setOnTouchListener(this);
	...
	public boolean onTouch(View v, MotionEvent event) {
        ...
        {          
          ...
          {
             v.setAlpha(1f);
             Toast.makeText(getApplicationContext(), "Go back to Map",
