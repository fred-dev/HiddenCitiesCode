...
public class PVuforia
{
	...
	public static class VuforiaSession implements UpdateCallbackInterface
	{
		...
		public void initAR(Fragment aFragment, int screenOrientation)
		{
			...
			mFragment.getActivity().setRequestedOrientation(screenOrientation);
			...
			mFragment.getActivity().getWindow().setFlags(
		...
		public class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
		{
			...
			public Boolean doInBackground(Void... params)
			{
				...
				synchronized (mShutdownLock) {
					Vuforia.setInitParameters(mFragment.getActivity(), mVuforiaFlags);
		...
		{
			Configuration config = mFragment.getActivity().getResources().getConfiguration();
