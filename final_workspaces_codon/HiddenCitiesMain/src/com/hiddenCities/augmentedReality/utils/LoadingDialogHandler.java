...
package com.hiddenCities.augmentedReality.utils;
...
public final class LoadingDialogHandler extends Handler
{
    ...
    public LoadingDialogHandler(Fragment aFragment)
    {
        mActivity = new WeakReference<Activity>(aFragment.getActivity());
    }
