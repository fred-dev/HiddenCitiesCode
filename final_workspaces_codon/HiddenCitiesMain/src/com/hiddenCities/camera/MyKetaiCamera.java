 ...
 * 
 */
public class MyKetaiCamera extends PImage
{
	...
	public Method			onPreviewEventMethod, onPreviewEventMethodPImage,
			onSavePhotoEventMethod, onFaceDetectionEventMethod;

	/** The camera id. */
	public int				frameWidth, frameHeight, cameraFPS, cameraID;
	...
	public Vector<Method>	listeners				= new Vector<Method>();
	...
	// public ketaiFaceDetectionListener facelistener;
	 ...
	 */
	public MyKetaiCamera(PApplet pParent, int _width, int _height,
	...
	public void determineObjectIntentions(Object o)
	{
		try {
		...
		try {
			onPreviewEventMethodPImage = o.getClass()
					.getMethod("onCameraPreviewEvent",
							new Class[] { MyKetaiCamera.class });
		} catch (NoSuchMethodException e) {
			// no such method, or an error.. which is fine, just ignore
	...
	public boolean saveRotatedPhoto(String aFilename)
	{
		final String _filename = aFilename;
		...
		if (camera != null && isStarted())
			camera.takePicture(null, null, jpegRotatedCallback);
	...
	PreviewCallback					previewcallback		= new PreviewCallback() {
																	...
																	Camera camera)
															{
																...
																if (myPixels == null
																		|| myPixels.length != frameWidth
																				* frameHeight)
																	myPixels = new int[frameWidth
																			* frameHeight];
																...
																if ((parent
																		.millis() - lastProcessedFrame) < (1000 / cameraFPS))
																	return;

																lastProcessedFrame = parent
																		.millis();
																if (onPreviewEventMethod != null
																		&& myPixels != null)
																	try {
																		onPreviewEventMethod
																...
																if (onPreviewEventMethodPImage != null
																		&& myPixels != null) {
																	try {
																		onPreviewEventMethodPImage
																				.invoke(callbackdelegate,
	...
	public AutoFocusCallback		autofocusCB			= new AutoFocusCallback() {
															public void onAutoFocus(
																	...
																	Camera c)
															{
																PApplet.println("Autofocus result: "
																		+ result);
															}
														};
	...
	public PictureCallback			jpegRotatedCallback	= new PictureCallback() {
															public void onPictureTaken(
																	byte[] data,
																	Camera camera)
															{
	...
	public OnScanCompletedListener	myScannerCallback	= new OnScanCompletedListener() {
															public void onScanCompleted(
																	...
																	Uri arg1)
															{
																PApplet.println("Media Scanner returned: "
																		+ arg1.toString()
																		+ " => "
																		+ arg0);
															}
	 ...
	 */
	public void determineCameraParameters()
	{
		if (camera == null)
			return;
