...
public class MoviePlayer {
    private static final String TAG = "Movie Player :: ";
    ...
    public MoviePlayer(File sourceFile, Surface outputSurface, FrameCallback frameCallback)
        ...
        System.out.println("making the MoviePlayer");
        ...
        try {
            ...
            audioExtractor.setDataSource(sourceFile.toString());
            System.out.println("extracted" + sourceFile.toString());
    ...
    private static int selectTrack(MediaExtractor extractor) {
        ...
        for (int i = 0; i < numTracks; i++) {
            ...
            System.out.println("Track No."+i+" Format is " +format.getString(MediaFormat.KEY_MIME) );
            String mime = format.getString(MediaFormat.KEY_MIME);
