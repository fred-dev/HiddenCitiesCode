...
public class PVuforia
{

	public static class VuforiaSession implements UpdateCallbackInterface
	{

		public static final String			LOGTAG			= "Vuforia_Sample_Applications";

		// Reference to the current activity
		public processing.core.PApplet					mPApplet;
		public VuforiaControl	mSessionControl;
		...
		public InitVuforiaTask				mInitVuforiaTask;
		...
		public Matrix44F					mProjectionMatrix;
		...
		public void initAR(PApplet aPApplet, int screenOrientation)
		{
			...
			mPApplet.getActivity().setRequestedOrientation(screenOrientation);

			updatePAppletOrientation();
			...
			mPApplet.getActivity().getWindow().setFlags(
		...
		public class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
		{
			...
			public int	mProgressValue	= -1;

			public Boolean doInBackground(Void... params)
			{
				// Prevent the onDestroy() method to overlap with initialization:
				synchronized (mShutdownLock) {
					Vuforia.setInitParameters(mPApplet.getActivity(), mVuforiaFlags);
			...
			public void onPostExecute(Boolean result)
			{
				...
				if (result) {
					...
					// Log error:
					Log.e(LOGTAG, "InitVuforiaTask.onPostExecute: "
							+ logMessage + " Exiting.");
		...
		public void storeScreenDimensions()
		{
			...
			mPApplet.getActivity().getWindowManager().getDefaultDisplay()
					.getMetrics(metrics);
		...
		public void updatePAppletOrientation()
		{
			Configuration config = mPApplet.getActivity().getResources().getConfiguration();
		...
		public void configureVideoBackground()
		{
			...
			Log.i(LOGTAG,
					"Configure Video Background : Video (" + vm.getWidth()
							+ " , " + vm.getHeight() + "), Screen ("
	...
	public static interface VuforiaControl
	{
	...
	public static class VuforiaException extends Exception
	{
